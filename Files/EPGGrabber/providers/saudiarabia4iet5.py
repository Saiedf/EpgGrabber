...
# Paths
input_path = os.path.join(EPG_ROOT, 'saudiarabia5.xml')
...
def main():
    # Added code snippet
    print("**************Saudiarabia5_iet5_EPG****************")
    sys.stdout.flush()  # Flush after the initial print
    sleep(1)  # Add a 1-second delay
    print("=============================================")

    print("Downloading Saudiarabia5_iet5 EPG guide\nPlease wait....")
    sys.stdout.flush()
    try:
        # Download the XML file
        response = requests.get('https://www.open-epg.com/files/saudiarabia5.xml', verify=False)
        if response.status_code == 200:
            ...
            print("============================================")
            print("Saudiarabia5.xml Downloaded Successfully")
            ...
            print("Failed to download /Saudiarabia5.xml. Status code: {}".format(response.status_code))
            sys.exit(1)  # Exit if download fails
    except requests.exceptions.RequestException as e:  # Corrected exception syntax
        print("Failed to download /Saudiarabia5.xml: {}".format(e))
...
def update_providers():
    with open(PROVIDERS_ROOT, 'r') as f:
        ...
        for channel in data['bouquets']:
            if channel["bouquet"] == "saudiarabia5iet5":
